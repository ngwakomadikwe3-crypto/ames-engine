...
function JewelryModel({ url, onRead, selectedMeshId, metalPreset }: { url: string; onRead: (report: JewelryAssetReadResult) => void; selectedMeshId?: string; metalPreset: JewelryMetalPreset }) {
  ...
  useEffect(() => {
    ...
    const roleByMeshId = new Map(materialPlan.assignments.map((assignment) => [assignment.meshId, assignment.role]))
